...
#      post :create, {:worktype => { :name => 'TX', :description => 'test', :needs_review => false, :preload => true, :is_continuous => false }}, { :user_id => users(:fred).id }
#    end
#
...
#    put :update, {:id => worktypes(:one).id, :worktype => { :name => 'TX', :description => 'test update', :needs_review => false,:preload => true, :is_continuous => false }} , { :user_id => users(:fred).id }
